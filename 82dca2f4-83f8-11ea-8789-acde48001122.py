...
@tracer(cat_col = ['sex', 'race'], numerical_col = ['age', 'hours-per-week'], sensi_atts=['sex', 'race'], target_name = "income-per-year", training=True, save_path="experiments/82dca2f4-83f8-11ea-8789-acde48001122", dag_save="svg")
def adult_pipeline_easy(f_path = "./media/82dca2f4-83f8-11ea-8789-acde48001122.csv"):
